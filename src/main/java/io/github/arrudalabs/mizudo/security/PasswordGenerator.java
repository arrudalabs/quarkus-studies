...
public class PasswordGenerator {
    ...
    public static final String ITERATION_COUNT_PROPERTY = "services.PasswordGeneratorService.PBEKeySpec.iterationCount";
    ...
    public static final String KEY_LENGTH_PROPERTY = "services.PasswordGeneratorService.PBEKeySpec.keyLength";
    ...
    public static final String SECRET_KEY_ALGORITHM_PROPERTY = "services.PasswordGeneratorService.SecretKeyFactory.algorithm";
